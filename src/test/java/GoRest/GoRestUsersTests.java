...
public class GoRestUsersTests {
    ...
    public void setup() {
        ...
        reqSpec = new RequestSpecBuilder()
                .addHeader("Authorization", "Bearer 7d6fbbc1e5cf6e659535f279d39e3d607dbb1ee5874b08b1e7142874ea88ff10")
    ...
    public void createUserMap() {
        ...
        userID =
                given()
                        .header("Authorization", "Bearer 7d6fbbc1e5cf6e659535f279d39e3d607dbb1ee5874b08b1e7142874ea88ff10")
                        .contentType(ContentType.JSON)
                        .body(newUser)
                        .log().uri()
                        //.log().body()
    ...
    public void updateUser() {
        ...
        updateUser.put("name", "haydarcan durmaz");
        ...
        given()
                ...
                .statusCode(200)
                .body("id", equalTo(userID))
                .body("name", equalTo("haydarcan durmaz"))
        ;
    }
